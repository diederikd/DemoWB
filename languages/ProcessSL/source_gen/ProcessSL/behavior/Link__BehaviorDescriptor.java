...
public final class Link__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getTransactionKindFromId_id4obCttud_xd = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getTransactionKindFromId").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4obCttud_xd").registry(REGISTRY).build();
  public static final SMethod<String> getTransactionKindToId_id4obCttud_xp = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getTransactionKindToId").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("4obCttud_xp").registry(REGISTRY).build();
  public static final SMethod<SNode> getTransactionKindFrom_id6z7DEV5Oyvh = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTransactionKindFrom").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6z7DEV5Oyvh").registry(REGISTRY).build();
  public static final SMethod<SNode> getTransactionKindTo_id6z7DEV5OvtJ = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTransactionKindTo").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6z7DEV5OvtJ").registry(REGISTRY).build();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getTransactionKindFromId_id4obCttud_xd, getTransactionKindToId_id4obCttud_xp, getTransactionKindFrom_id6z7DEV5Oyvh, getTransactionKindTo_id6z7DEV5OvtJ, getStepKindFrom_id6z7DEV5O_li, getStepKindTo_id6z7DEV5Oxs$, isExternal_id4obCtttCqTy);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String getTransactionKindFromId_id4obCttud_xd(@NotNull SNode __thisNode__) {
    return TransactionKind__BehaviorDescriptor.getTransactionKindId_id6z7DEV5OneK.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c841L, 0x585f5ae0f86c847L, "transactionKindStepKindFrom")), MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c73eL, 0x585f5ae0f86c73fL, "transactionKind"))) + SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c841L, 0x585f5ae0f86c847L, "transactionKindStepKindFrom")), MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c73eL, 0x585f5ae0f86c73fL, "transactionKind")), MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa18f05L, 0x2613bb9aeaa18f06L, "id"));
  }
  /*package*/ static String getTransactionKindToId_id4obCttud_xp(@NotNull SNode __thisNode__) {
    return TransactionKind__BehaviorDescriptor.getTransactionKindId_id6z7DEV5OneK.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c841L, 0x585f5ae0f86c842L, "transactionKindStepKindTo")), MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c73eL, 0x585f5ae0f86c73fL, "transactionKind"))) + SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c841L, 0x585f5ae0f86c842L, "transactionKindStepKindTo")), MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c73eL, 0x585f5ae0f86c73fL, "transactionKind")), MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa18f05L, 0x2613bb9aeaa18f06L, "id"));
  }
  /*package*/ static SNode getTransactionKindFrom_id6z7DEV5Oyvh(@NotNull SNode __thisNode__) {
  ...
  /*package*/ static SNode getTransactionKindTo_id6z7DEV5OvtJ(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c841L, 0x585f5ae0f86c842L, "transactionKindStepKindTo")), MetaAdapterFactory.getReferenceLink(0xa2c2ae097c364fbaL, 0x9b645e0450cb1363L, 0x585f5ae0f86c73eL, 0x585f5ae0f86c73fL, "transactionKind"));
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((String) getTransactionKindFromId_id4obCttud_xd(node));
      case 1:
        return (T) ((String) getTransactionKindToId_id4obCttud_xp(node));
      case 2:
        return (T) ((SNode) getTransactionKindFrom_id6z7DEV5Oyvh(node));
      case 3:
        return (T) ((SNode) getTransactionKindTo_id6z7DEV5OvtJ(node));
      case 4:

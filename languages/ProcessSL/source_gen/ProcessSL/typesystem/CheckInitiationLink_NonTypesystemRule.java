...
public class CheckInitiationLink_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public CheckInitiationLink_NonTypesystemRule() {
  }
      ...
      if (Link__BehaviorDescriptor.getTransactionKindFrom_id6z7DEV5Oyvh.invoke(link) == Link__BehaviorDescriptor.getTransactionKindTo_id6z7DEV5OvtJ.invoke(link)) {
        {
          ...
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(link, "Initiation should be a link to another transaction", "r:a1caa921-c9ff-45b1-8728-1f865d605911(ProcessSL.typesystem)", "5047305753769905599", null, errorTarget);
        }
      }
    }
  }

...
public final class IUpperCaseNamedConcept__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xaa59ea5e1883437fL, 0x95c04dc082aa848cL, 0x2613bb9aeaa0eb4fL, "GeneralSL.structure.IUpperCaseNamedConcept");
  private static final BehaviorRegistry REGISTRY = ConceptRegistry.getInstance().getBehaviorRegistry();

  public static final SMethod<String> getFqName_id2ojITFEFpQY = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFqName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2ojITFEFpQY").registry(REGISTRY).build();
  ...
  public static final SMethod<String> getFullName_id2ojITFEFpTK = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFullName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2ojITFEFpTK").registry(REGISTRY).build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getFqName_id2ojITFEFpQY, getDescriptionText_id69Qfsw3IqwE, getPresentation_id69Qfsw3IoJg, getFullName_id2ojITFEFpTK);
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((String) getFqName_id2ojITFEFpQY(node));
      case 1:
      ...
      case 3:
        return (T) ((String) getFullName_id2ojITFEFpTK(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }

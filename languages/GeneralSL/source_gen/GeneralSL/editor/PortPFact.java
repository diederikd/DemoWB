...
public class PortPFact extends AbstractShape {
  ...
  protected void draw(final Graphics2D graphics, final Rectangle2D bounds, IShapeStyle style) {
    ...
    Ellipse2D.Double reDouble = new Ellipse2D.Double(bounds.getX(), bounds.getY(), bounds.getWidth(), bounds.getHeight());
    graphics.draw(reDouble);
    Ellipse2D.Double reDouble2 = new Ellipse2D.Double(bounds.getX() + lt, bounds.getY() + lt, bounds.getWidth() - lt - 1, bounds.getHeight() - lt - 1);

...
<model ref="00000000-0000-4000-5f02-5beb5f025beb/i:fb4cac1(checkpoints/Action.structure@descriptorclasses)">
  <persistence version="9" />
  <attribute name="checkpoint" value="DescriptorClasses" />
  <attribute name="generation-plan" value="AspectCPS" />
  <languages />
  <imports>
    <import index="qiqe" ref="r:f3f9f666-f463-4dc0-bd8d-a9e7e33b8917(Action.structure)" />

...
/*package*/ class Executor_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Executor_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_k9rz1o_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_k9rz1o_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_k9rz1o_b0");
  ...
  private EditorCell createRefCell_0() {
    ...
    provider.setNoTargetText("<select executor>");
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new Executor_EditorBuilder_a.Executor_actorRole_cellMenu_k9rz1o_a0c0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        editorCell.setDefaultText("<select executor>");
  ...
  public static class Executor_actorRole_cellMenu_k9rz1o_a0c0 extends PrimaryReferentMenuCellMenuPart {
    public Executor_actorRole_cellMenu_k9rz1o_a0c0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_k9rz1o_a0a2a;
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getVisibleMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_k9rz1o_a0a2a_0;
    }
  }
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        if ((SLinkOperations.getTarget(myNode, MetaAdapterFactory.getReferenceLink(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x6331c55a1a6904bdL, 0x6331c55a1a6904eaL, "actorRole")) != null)) {
          return "(" + AbstractActorRole__BehaviorDescriptor.getID_id1S2F7pXAkU4.invoke(SLinkOperations.getTarget(myNode, MetaAdapterFactory.getReferenceLink(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x6331c55a1a6904bdL, 0x6331c55a1a6904eaL, "actorRole"))) + ")";
        }
        return "";
      }
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_k9rz1o_d0");
    Style style = new StyleImpl();

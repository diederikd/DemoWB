...
/*package*/ class CompositeActorRole_OCD_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public CompositeActorRole_OCD_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_odjge3_a");
                          ...
                          public Iterable<SNode> query() {
                            List<SNode> actorRoles = new ArrayList<SNode>();
                            {
                              ...
                              if (SNodeOperations.isInstanceOf(constructionModel, MetaAdapterFactory.getConcept(0x61f0ccba8ded47eeL, 0xb0248f1c223c70efL, 0x1ed669b9cb8051f7L, "DemoSL.structure.ConstructionModel"))) {
                                actorRoles = Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(constructionModel, MetaAdapterFactory.getContainmentLink(0x61f0ccba8ded47eeL, 0xb0248f1c223c70efL, 0x1ed669b9cb8051f7L, 0x1ed669b9cb805203L, "actorRoles")), MetaAdapterFactory.getConcept(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa032a9L, "ConstructionSL.structure.ActorRole"))).where(new IWhereFilter<SNode>() {
                                  public boolean accept(SNode it) {
                                    return Sequence.fromIterable(SLinkOperations.collect(SLinkOperations.getChildren(it, MetaAdapterFactory.getContainmentLink(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa032a9L, 0x2e078028fd61c14cL, "isActorRoleInCAR")), MetaAdapterFactory.getReferenceLink(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2e078028fd647073L, 0x2e078028fd647074L, "compositeActorRole"))).contains(node);
                                  }
                                }).toListSequence();
                              }
                            }

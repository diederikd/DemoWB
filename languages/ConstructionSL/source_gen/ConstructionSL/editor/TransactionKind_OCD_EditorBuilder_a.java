...
/*package*/ class TransactionKind_OCD_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public TransactionKind_OCD_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_xek190_a");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_xek190_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private boolean _StyleParameter_QueryFunction_xek190_a0d0() {
  ...
  private boolean _StyleParameter_QueryFunction_xek190_a1d0() {
  ...
  private boolean _StyleParameter_QueryFunction_xek190_a2d0() {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_xek190_e0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_xek190_a4a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_xek190_b4a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_xek190_d4a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_xek190_e4a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_xek190_f4a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    if (_StyleParameter_QueryFunction_xek190_a1f4a()) {
      new tfDocumentalProductionStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    }
    if (_StyleParameter_QueryFunction_xek190_a2f4a()) {
      new tfOriginalProductionStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    }
    if (_StyleParameter_QueryFunction_xek190_a3f4a()) {
      new tfInformationalProductionStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    }
    editorCell.getStyle().putAll(style);
  ...
  private boolean _StyleParameter_QueryFunction_xek190_a1f4a() {
    return SPropertyOperations.hasValue(getNode(), MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa18f05L, 0x2613bb9aeaa55dc1L, "type"), "documental", "original");
  }
  private boolean _StyleParameter_QueryFunction_xek190_a2f4a() {
    return SPropertyOperations.hasValue(getNode(), MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa18f05L, 0x2613bb9aeaa55dc1L, "type"), "original", "original");
  }
  private boolean _StyleParameter_QueryFunction_xek190_a3f4a() {
    return SPropertyOperations.hasValue(getNode(), MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa18f05L, 0x2613bb9aeaa55dc1L, "type"), "informational", "original");
  }
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_xek190_a5e0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_7() {
    ...
    editorCell.setCellId("Constant_xek190_f0");
    editorCell.setDefaultText("");
    return editorCell;
  }
      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new TransactionKind_OCD_EditorBuilder_a.Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell();
          }
  ...
  private EditorCell createConstant_8() {
    ...
    editorCell.setCellId("Constant_xek190_h0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new TransactionKind_OCD_EditorBuilder_a.Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, "executor");
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
  ...
  private EditorCell createConstant_9() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_xek190_j0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");

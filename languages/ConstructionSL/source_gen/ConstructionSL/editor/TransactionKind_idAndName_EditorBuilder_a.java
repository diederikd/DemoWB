...
/*package*/ class TransactionKind_idAndName_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public TransactionKind_idAndName_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean _StyleParameter_QueryFunction_8uaqmh_a1a() {
  ...
  private boolean _StyleParameter_QueryFunction_8uaqmh_a2a() {
  ...
  private boolean _StyleParameter_QueryFunction_8uaqmh_a3a() {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_8uaqmh_a0");
    Style style = new StyleImpl();

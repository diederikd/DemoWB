...
/*package*/ class TransactionKind_TPT_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_q1rqn4_a1a0() {
  ...
  private boolean _StyleParameter_QueryFunction_q1rqn4_a2a0() {
  ...
  private boolean _StyleParameter_QueryFunction_q1rqn4_a3a0() {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_q1rqn4_a0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_q1rqn4_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);

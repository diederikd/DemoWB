...
public final class IUpperCaseNamedConcept__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa0eb4fL, "Construction.structure.IUpperCaseNamedConcept");
  private static final BehaviorRegistry REGISTRY = ConceptRegistry.getInstance().getBehaviorRegistry();

  public static final SMethod<String> getFqName_id2ojITFECsSO = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFqName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2ojITFECsSO").registry(REGISTRY).build();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getFqName_id2ojITFECsSO, getDescriptionText_id69Qfsw3IqwE, getPresentation_id69Qfsw3IoJg);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String getFqName_id2ojITFECsSO(@NotNull SNode __thisNode__) {
    SModel model = SNodeOperations.getModel(__thisNode__);
    if (model == null) {
      return SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa0eb4fL, 0x2613bb9aeaa0eb50L, "name"));
    }
    ...
    return longName + '.' + SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xd87481a388534c7cL, 0x9cb5096d805e832cL, 0x2613bb9aeaa0eb4fL, 0x2613bb9aeaa0eb50L, "name"));
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((String) getFqName_id2ojITFECsSO(node));
      case 1:

...
public class PerformNo {
  public static void setCellActions(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setAction(CellActionType.CLICK, new PerformNo.PerformNo_CLICK(node));
  }
  public static class PerformNo_CLICK extends AbstractCellAction {
    /*package*/ SNode myNode;
    public PerformNo_CLICK(SNode node) {
      this.myNode = node;
    }

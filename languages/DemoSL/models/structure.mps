...
<model ref="r:653333d6-8f0c-4abd-b1f1-16ec465e41bc(DemoSL.structure)">
  ...
  <node concept="1TIwiD" id="ZMabRdGIoF">
    <property role="EcuMT" value="1149025650597881387" />
    <property role="TrG5h" value="GenerateToAws" />
    <property role="19KtqR" value="true" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="PrWs8" id="ZMabRdGIoG" role="PzmwI">
      <ref role="PrY4T" to="tpck:h0TrEE$" resolve="INamedConcept" />
    </node>
  </node>
</model>

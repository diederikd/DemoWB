...
/*package*/ class EntityTypeSet_OFD_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public EntityTypeSet_OFD_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jwp7uk_a");
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_jwp7uk_a0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_jwp7uk_a0a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_jwp7uk_b0a0");
